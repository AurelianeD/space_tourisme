...
<main class="mx-7 lg:mx-36">
		<h1 class="font-barlow text-h5 text-center my-10 md:text-left md:text-h5-tablet lg:my-0">
		...
		<div class="flex flex-col lg:flex-row items-center order-2 md:order-1 justify-center">
			...
			<img src="{$currentCrew.image}" alt="{$currentCrew.name}" class="w-2/4 md:w-1/3 lg:w-full border-b border-gray md:border-none order-1 md:order-2"/>
		</div>
</main>